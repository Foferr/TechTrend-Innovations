...
export default function Register() {
    ...
    const nombresExampleText = language === 'es' ? 'Miguel Angel' : 'Michael/s';
    const apellidosExampleText = language === 'es' ? 'Perez Juarez/s' : 'Smith Jones/s';
