...
export default function Home() {
  ...
  const words:string[] = {
    es: ['Tu asistente de confianza', 'Conoce los productos de Neoris', '' + 'Información a un mensaje de distancia', 'Potenciado por AI'],
    en: ['Your trustworthy assistant', 'Learn about Neoris products', 'Information, one prompt away', 'Powered by AI']
  }
