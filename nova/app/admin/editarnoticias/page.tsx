          ...
          <table className="w-full table-auto text-center border-collapse">
            <thead>
              <tr>
                ...
                <th className="border-b py-4">{columnNames[language].estatus}</th>
                <th className="border-b py-4">{columnNames[language].creacion}</th>
                <th className="border-b py-4">{columnNames[language].acciones}</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
